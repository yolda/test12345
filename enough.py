...
|___/|_|\_\|_|   |_|    \__|
    ...
    try:
        menu = (input(Fore.LIGHTMAGENTA_EX + " 1- SMS Attackt\n 2- Discord\n 3- Çıkış\n\n" + Fore.LIGHTYELLOW_EX + " Tercih: "))
        if menu == "":
            continue
        menu = int(menu) 
    except ValueError:
    ...
    if menu == 1:
        system("cls||clear")
        print(Fore.LIGHTYELLOW_EX + "'0' Koymadan numarayı yazınız: "+ Fore.LIGHTGREEN_EX, end="")
        tel_no = input()
        tel_liste = []
        if tel_no == "":
            system("cls||clear")
    ...
    """
        ...
        system("cls||clear")
        print(Fore.LIGHTWHITE_EX + " discord.gg/Jy5T8V8")
        sleep(12)
    elif menu == 3:
        system("cls||clear")
        print(Fore.LIGHTRED_EX + "imha ediliyor...")
        break
